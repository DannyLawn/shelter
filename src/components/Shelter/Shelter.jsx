...
export default function Shelter() {
  ...
  return (
    <section className={styles.shelter}>
      ...
      <p className={styles.shelter__text}>Все будет в полном ажуре. В то же время, при экстренной ситуации, лучше полагаться не только на случай. Списки укрытий будут пополняться модерацией по мере необходимости. Данные проверяется вручную. Статусы свободных мест обновляются.</p> 
